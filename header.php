...
<head>
    ...
    <link rel="shortcut icon" href="images/de.png" type="image/x-icon">

    <title>Destiny</title>
</head>
<body>
<div class="header_bar">
    <a href="index.php" style="text-decoration: none; color: #44c2d8;"><img src="images/de.png" alt="O" style="height: 40px; width: 40px; margin: 18px 3px -10px 30px;">
    <span style="font-family: Roboto;/*! text-decoration: none; */font-size: 26px;">ESTINY</span></a>
